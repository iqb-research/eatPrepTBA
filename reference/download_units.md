...
This function downloads units from the IQB Studio Lite. If Testcenter
logins are generated by `add_testtakers_*`, current Studio Lite writes
the generated testtakers file as `<booklet-id>_testtaker.xml`, e.g.
...
- add_testtakers_hot:
  ...
  Numeric. Number of Testcenter testtaker logins (`run-hot-return`).
  Defaults to `0`.
...
- booklet_label:
  ...
  Character. Optional label for the generated booklet when Testcenter
  logins are added. Studio Lite 18.0 uses this top-level download
  setting for `Booklet/Metadata/Label`.
