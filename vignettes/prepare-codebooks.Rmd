...
The example uses Studio version `20.0.1`. If your Studio login page shows a different version, use that value for `app_version`. Replace the example workspace ID `1300` with an ID available to your account.
