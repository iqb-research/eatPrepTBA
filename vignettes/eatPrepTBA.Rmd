...
(for example, at <https://www.iqb-studio.de>). Workspace IDs below are examples;
...
The output below uses one anonymized example unit, prepared with the current
metadata reader from a saved response adapted to the current metadata format.
It is an illustration, not a live download.
